...
echo "logs/pred/usefull_states/wlan/wlan_5_"$ttm"_uf.log" > addr.txt
./bin/prism ../prism-examples/mdps/wlan/wlan5.nm ../prism-examples/mdps/wlan/wlan.pctl -s -prop 2 -noprob1 -const k=5,TRANS_TIME_MAX=$ttm -mod3 > logs/compare/state_based/wlan/wlan_5_$ttm\_usefull_states.log
