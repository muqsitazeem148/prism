...
public class PrismSettings implements Observer
{
	...
	public static final Object[][][] propertyData =
	{
		{	//Datatype:			Key:									Display name:							Version:		Default:																	Constraints:																				Comment:
			...
			{ CHOICE_TYPE,		PRISM_MDP_SOLN_METHOD,					"MDP solution method",				"4.0",			"Value iteration",																"Value iteration,Gauss-Seidel,Policy iteration,Modified policy iteration,Linear programming,mod1,mod2,mod3,mod4,mod5",
	...
	public synchronized int setFromCommandLineSwitch(String args[], int i) throws PrismException
	{
		...
		} else if (sw.equals("mod1")) {
			set(PRISM_MDP_SOLN_METHOD, "mod1");
		} else if (sw.equals("mod2")) {
			set(PRISM_MDP_SOLN_METHOD, "mod2");
		} else if (sw.equals("mod3")) {
			set(PRISM_MDP_SOLN_METHOD, "mod3");
		} else if (sw.equals("mod4")) {
			set(PRISM_MDP_SOLN_METHOD, "mod4");
		} else if (sw.equals("mod5")) {
			set(PRISM_MDP_SOLN_METHOD, "mod5");
